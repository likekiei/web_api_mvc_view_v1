...
namespace Main_Common.Model.ResultApi.ProductInspection
{
    /// <summary>
    /// 【Api】【回傳結果】
    /// </summary>
    public class ProductInspectionResult
    {
        ...
        /// 回傳資料
        /// </summary>
        public List<MfTiProductInspection_DTO> Datas { get; set; }
        ...
        /// 建構-初始值
        /// </summary>
        public ProductInspectionResult()
        {
            // ...
        }
        ...
        public ProductInspectionResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message)
        {
            if (defaultSuccess)
            {
                this.IsSuccess = true;
        ...
        public ProductInspectionResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message, List<MfTiProductInspection_DTO> data)
        {
            if (defaultSuccess)
            {
                this.IsSuccess = true;
