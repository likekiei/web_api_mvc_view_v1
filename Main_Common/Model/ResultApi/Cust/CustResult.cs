...
namespace Main_Common.Model.ResultApi
{
    ...
    public class CustResult
    {
        ...
        /// 回傳資料
        /// </summary>
        public List<CUST_DTO> Datas { get; set; }
        /// <summary>
        /// 回傳資料
        /// </summary>
        public CUST_DTO Data { get; set; }
        #endregion
        ...
        public CustResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message)
        {
            if (defaultSuccess)
            {
                this.IsSuccess = true;
        ...
        public CustResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message, CUST_DTO data)
        {
            if (defaultSuccess)
            {
                this.IsSuccess = true;
        ...
        /// <param name="data">資料</param>
        public CustResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message, Pageing_DTO pageDTO, List<CUST_DTO> data)
        {
            if (defaultSuccess)
            {
                this.IsSuccess = true;
