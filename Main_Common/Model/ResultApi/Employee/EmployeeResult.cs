...
namespace Main_Common.Model.ResultApi
{
    ...
    public class EmployeeResult
    {
        ...
        /// 回傳資料
        /// </summary>
        public List<EmployeeDTO> Datas { get; set; }
        /// <summary>
        /// 回傳資料
        /// </summary>
        ...
        public EmployeeResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message)
        {
            if (defaultSuccess)
            {
                this.IsSuccess = true;
        ...
        //public EmployeeResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message, EmployeeDTO data)
        //{
        //    if (defaultSuccess)
        //    {
        //        this.IsSuccess = true;
        ...
        /// <param name="data">資料</param>
        public EmployeeResult(string userID, bool defaultSuccess, E_StatusCode statusType, string message, Pageing_DTO pageDTO, List<EmployeeDTO> data)
        {
            if (defaultSuccess)
            {
                this.IsSuccess = true;
