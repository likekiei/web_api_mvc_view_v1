...
namespace Main_Web.Controllers
{
    ...
    /// </summary>
    [Authorize]
    public class HomeAdminController : BaseWebController
    {
        #region == 【DI注入用宣告】 ==
        /// <summary>
        /// 【DTO】主系統資料
        ...
        {
            return PartialView("_Admin_Layout_TopBar", this._MainSystem_DTO.UserSession);
        }
        ...
        public ActionResult GetMenuBar_View()
        {
            ...
            return PartialView("_Admin_Layout_MenuBar", functions);
        }
        ...
        {
            var functions = this._MainSystem_DTO.UserSession != null ? this._MainSystem_DTO.UserSession.Functions : new List<E_Function>();
            return PartialView("_Admin_Layout_SideBar", functions);
        }
        ...
        {
            return PartialView("_Admin_Layout_Footer", this._MainSystem_DTO.UserSession);
        }
        #endregion
    }
}
