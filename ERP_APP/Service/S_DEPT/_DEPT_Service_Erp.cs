...
//        /// [Table]客戶
//        /// </summary>
//        private C_ERP_Repository<DEPT> _DEPT_Repository;
...
//        //private List<DEPT_DTO> _DEPT_DTOs = new List<DEPT_DTO>();
//        #endregion
...
//        public DEPT_Service_Erp(UserSession_Model input)
//        {
...
//            _DEPT_Repository = new C_ERP_Repository<DEPT>(db);
...
//        public bool Check_IsExist_DEPT_ByNo(string no)
//        {
//            var check = _DEPT_Repository.GetAlls(x => x.DEP == no).Any();
//            return check;
//        }
...
//        {
//            var data = _DEPT_Repository.GetAlls(x => x.DEP == no);
//            return data.Any();
//        }

//        /// <summary>
//        /// 【單筆】檢查部門是否存在(依外部單號) [true存在]
//        /// </summary>
//        /// <param name="cNo">外部單號</param>
//        /// <returns>[true：存在]</returns>
//        //public bool Check_IsExist_DEPT_ByOuterNo(string cNo)
//        //{
//        //    var check = _DEPT_Repository.GetAlls(x => x.OS_ID == "SO" && x.C_No == cNo).Any();
//        //    return check;
//        //}

//        /// <summary>
//        /// 【多筆】檢查部門是否存在(依外部單號) [true存在]
//        /// </summary>
...
//        public DEPT Get_DEPT_Data(string no)
//        {
//            //POS_Related result = new POS_Related();

//            var DEPT = _DEPT_Repository.Get(x => x.DEP == no);
...
//        /// <param name="no"></param>
//        /// <returns>Data</returns>
//        public List<DEPT> Get_DEPT_Datas()
//        {
//            //POS_Related result = new POS_Related();

//            var DEPTs = _DEPT_Repository.GetAll().ToList();
...
//        //    var DEPTNos = inputs.Select(x => x.DEPT_No).Distinct().ToList();
//        //    _DEPT_DTOs = _DEPT_Repository.GetAlls(x => DEPTNos.Contains(x.CUS_NO)).Select(x => new DEPT_DTO
//        //    {
//        //        No = x.CUS_NO,
//        //        Name = x.NAME,
//        //    }).ToList();
...
//        //        // 通用的默認關鍵值訊息 (如不一樣請客製)
//        //        var comFoDEPTXT = $"Key[{input.ID}]---代號[{input.No}]";
...
//        //            )
//        //        {
//        //            message_DTO = new Message_Model(false, E_StatusCode.檢查異常, "", comFoDEPTXT, input.Bind_Key);
//        //            message_DTO.Table_Key_Main = input.ID.HasValue ? input.ID.Value.ToString() : null;
//        //            message_DTO.Message = "部門，來源入庫單表頭資料存在空值，請檢查以下項目是否有值『Key、單號、單據日期、進站日期』";
...
//        //                message_DTO = new Message_Model(false, E_StatusCode.檢查異常, "", comFoDEPTXT, input.Bind_Key);
//        //                message_DTO.Table_Key_Main = input.ID.HasValue ? input.ID.Value.ToString() : null;
//        //                message_DTO.Message = "部門，來源入庫單表身資料存在空值，請檢查以下項目是否有值『Key、SN、表頭Key、表頭單號、產品ID、產品代號、數量』";
...
//        //            catch (Exception ex)
//        //            {
//        //                message_DTO = new Message_Model(false, E_StatusCode.資料存取異常, "部門，資料庫存取異常", comFoDEPTXT, input.Bind_Key);
...
//        //            catch (Exception)
//        //            {
//        //                tmPOStherMsgs.Add("部門，庫存調整時，發生例外狀況"); // 異常訊息
//        //            }
//        //            #endregion

//        //            #region == 成功的Message整理 ==
//        //            // 暫時的默認關鍵值訊息 (當作查詢用的關鍵字而已)
//        //            tmpFoDEPTXT = $"Key[{input.ID}]---代號[{input.No}]---Erp部門單號[{newData.MF_POS.OS_NO}]";
//        //            message_DTO = new Message_Model(true, E_StatusCode.成功, "部門，新增拋轉成功", tmpFoDEPTXT, input.Bind_Key);
...
//        //        else
//        //        {
//        //            message_DTO = new Message_Model(false, E_StatusCode.存在相同資料, "部門，存在相同Key", comFoDEPTXT, input.Bind_Key);
//        //            message_DTO.Table_Key_Main = input.ID.HasValue ? input.ID.Value.ToString() : null;
...
//        //    // 通用的默認關鍵值訊息 (如不一樣請客製)
//        //    var comFoDEPTXT = $"MF_Key[{input.ID}]---代號[{input.No}]";
//        //    // 暫時的默認關鍵值訊息 (當作查詢用的關鍵字而已)
//        //    var tmpFoDEPTXT = "";

//        //    #region == 檢查-客戶是否存在 (Error return) ==
//        //    check = _DEPT_DTOs.Where(x => x.No == input.DEPT_No).Any();
//        //    // [T：查無]
//        //    if (!check)
//        //    {
//        //        message_DTO = new Message_Model(false, E_StatusCode.檢查異常, $"部門，查無客戶，「客戶代號：{input.DEPT_No}」", comFoDEPTXT, input.Bind_Key);
//        //        message_DTO.Table_Key_Main = input.ID.HasValue ? input.ID.Value.ToString() : null;
...
//        //    {
//        //        message_DTO = new Message_Model(false, E_StatusCode.檢查異常, $"部門，查無產品，「{string.Join(",", tmpErrorMsgs)}」", comFoDEPTXT, input.Bind_Key);
//        //        message_DTO.Table_Key_Main = input.ID.HasValue ? input.ID.Value.ToString() : null;
...
//        //    var posNo = this.GetNo_POS(input.Doc_Date.Value); // 部門單號
...
//        //    int snNo; // 流水號的部份
//        //    string presentNO;
//        //    var numberPrefix = E_NumberPrefix.部門.GetEnumDescription();
