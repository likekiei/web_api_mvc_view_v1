...
//namespace ERP_APP.Service.S_MF_ARP
//{
//    /// <summary>
//    /// 應收付款主庫相關
//    /// </summary>
//    public class MF_ARP_Service_Erp
//    {
//        #region == 【DI注入用宣告】 ==
//        /// <summary>
//        /// 資料庫工作單元
...
//        public bool Check_IsExist_ARP_NO(string no)
//        {
//            var check = _MF_ARP_Repository.GetAlls(x => x.ARP_NO == no).Any();
//            return check;
//        }
...
//        public string GetARPNo(DateTime day)
//        {
//            string presentNO = "";
//            string str = "AR";
...
//            if (_MF_ARP_Repository.GetAlls(x => x.ARP_NO.StartsWith(query) && x.ARP_NO.Substring(x.ARP_NO.Length - 1, 1) == "_").Any())
//            {
//                var temp = (int.Parse(_MF_ARP_Repository.GetAlls(x => x.ARP_NO.StartsWith(query) && x.ARP_NO.Substring(x.ARP_NO.Length - 1, 1) == "_").OrderByDescending(o => o.ARP_NO).FirstOrDefault().ARP_NO.Substring(6, 4)) + 1).ToString("0000");
...
//        /// <param name="no"></param>
//        /// <returns>true存在</returns>
//        public MF_ARP GetWH_ByDept(string no)
//        {
//            var data = _MF_ARP_Repository.GetAlls(x => x.DEP == no).SingleOrDefault();
//            return data;
